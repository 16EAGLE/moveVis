...
# **moveVis** log & release news

***
_Direct access:_ http://news.moveVis.org. _Last time updated:_ `r toString(Sys.time())`. _Disclaimer:_ This document should provide a broad overview on changes that are applied to the moveVis R package. There is no warranty for completeness, since minor changes might not be included. All improvement and feature descriptions are bundled per release version. The document is maintained by https://github.com/16EAGLE and is part of the http://movevis.org repository.

**CRAN:** version 0.9.6 public release, url: https://CRAN.R-project.org/package=moveVis  
**GitHub:** version 0.9.6, to be replaced by 0.9.7 BETA soon. url: http://moveVis.org
...
<br>
Further ideas for new features? Open a GitHub issue: https://github.com/16eagle/movevis/issues
