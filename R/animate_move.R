...
#' @param map_crop logical. Set to \code{TRUE} to rop the static basemap to the extent of \code{m}. Otherwise, use the static basemap with the best resolution for the given extent. Default is \code{FALSE}.
...
animate_move <- function(m, out_dir, conv_dir = "",
                         ...
                         layer_col = c("sandybrown","white","darkgreen"), layer_nacol = "white", map_type="satellite", api_key = NULL, map_zoom = 0, map_crop = FALSE, stats_create = FALSE, static_data = NA, static_gg = NA,
