...
#' @param proj projection, a character (proj4string) or a CRS object, indicating the projection that the coordinates of \code{df} represent.
...
#' @param ... additional arguments passed to \code{move}, e.g. \code{data} to add additional data such as path colours (see \code{\link{move}}).
#'
...
#' df2move(move_df, proj = "+init=epsg:4326 +proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0", 
